...
class CalendarEvent with _$CalendarEvent {
  ...
  const factory CalendarEvent.changeSelectedMonth(DateTime newMonth) = _ChangeSelectedMonth;

  const factory CalendarEvent.changeSelectedDate(DateTime newDate) = _ChangeSelectedDate;
